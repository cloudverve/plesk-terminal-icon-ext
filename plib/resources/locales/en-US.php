...
$messages = [
  ...
  'settingsIntroText' => sprintf( 'Please provide the URL to your Shell in a Box instance. For more information, see the <a href="%s" target="_blank">documentation</a>.', 'https://github.com/cloudverve/plesk-terminal-icon-ext/wiki' ),
